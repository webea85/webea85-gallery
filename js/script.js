...
$(document).ready(function() {
    ...
    function parallaxInit() {
        "use strict";
        $('.home-parallax').parallax("50%", 1);
        $('.subscribe-parallax').parallax("30%", 1);
        ...
        if (name && emaild && message) {
            $.ajax({
                ...
                success: function(data) {
                    $(".Sucess").show();
                    $(".Sucess").fadeIn(2000);
                    $(".Sucess").html("<i class='fa fa-check'></i> Dear <b>" + name + "</b> Спасибо за Ваш запрос, мы ответим Вам как можно скорее!");
                    $("#Name").val("");
                    $("#Email").val("");
                    $("#Subject").val("");
                    $("#Message").val("");
